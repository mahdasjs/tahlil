...
const theme = createMuiTheme({
  ...
  class post extends React.Component {  
    ...
    componentDidMount() {
      axios({
        method: 'get',
        url: `http://localhost:8000/api/v1/events/homepage/${this.props.postId}`,
    ...
    render(){
      ...
      const open = Boolean(anchorEl);
        ...
        let posts = this.state.songs.map(post => {
          ...
          const url ="http://localhost:3000/homepage/"+this.props.postId+"/"+this.props.postUser
      return(
                ...
                <Grid  item xs={12} sm={12} lg={12}>
                  ...
                  action={
                    <div               style={{
                      ...
                      { window.location.pathname.split('/')[1]==='user'&&window.location.pathname.split('/')[2]===Cookie.get('userid')?
                      <div>
                                          <IconButton
                                          aria-label="settings"
                  ...
                  <CardActions disableSpacing>
                   ...
                   />
                     <FormControlLabel
                      control={
                        <Checkbox  
                        onChange={this.handleClickOpenAdd}
                        color="default" 
                       icon={<Share style={{fontSize:30}} />} 
                       checkedIcon={<Share style={{fontSize:30}}/>}
                      name="checkedH" />}
                   />
                  </CardActions>
                  </div>
                  <div className="bottombar" style={{marginLeft:-27}}>
                  <CardActions disableSpacing>
                    <FormControlLabel
                    // style={{marginRight:'70%'}}
                    label={this.state.likeLength}
    ...
    show less                    
          ...
          style={{zIndex:100000000,maxHeight:600,marginTop:50}}
           ...
           Share</Typography>
               ...
               {/* <Sharefile icon={<Facebook/>} title={"Share to Facebook "}/>
               <Sharefile icon={<Twitter/>} title={"Share to Twitter "}/>
               <Sharefile icon={<Email/>} title={"Share via Email "}/>
               <Sharefile icon={<Link/>} title={"Copy Link "}/> */}
    <Facebook link={url}/>
    <br/>
          <Twitter link={"See this post on COMU.  "+ url} />
    <br/>
               <CopyToClipboard text={url}>
    <Button onClick={this.handleCloseAdd}>
